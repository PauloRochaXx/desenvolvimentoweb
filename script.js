...
let repeatOn = false;
const originalPlaylist = JSON.parse(localStorage.getItem("playlist")) ?? [bebiMinhaBicicleta, mulherMaravilha, notificacaoPreferida];
...
function initializeSong(){
    song.src = `/desenvolvimentoweb/songs/${sortedPlaylist[index].file}.mp3`;
    cover.src = `/desenvolvimentoweb/imagens/${sortedPlaylist[index].file}.png`;
    song.load(); 
